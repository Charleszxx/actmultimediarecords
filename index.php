...
<head>
    <meta charset="utf-8"/>
    <title>Sinking Fund Record</title>
...
?>
    ...
    <form class="form" action="submitted.php" method="post" name="login" autocomplete="off">
        <h1 class="login-title">Funds Records</h1>
        ...
        <span class="error" style="color:red;">Required*</span>
        <input type="text" class="login-input" name="amount" required placeholder="Amount Paid"/>
        <span class="error" style="color:red;">Required*</span>
        <input type="text" class="login-input" name="referral" required placeholder="Name of the person you paid for the funds?"/>
